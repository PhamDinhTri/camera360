package com.guoxiaoxing.camera.widget;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public MyHighlightView(ImageView context, int styleId, FeatherDrawable content) {
        ...
        mAnchorRotate = CameraApp.getApp().getResources().getDrawable(R.drawable.aviary_resize_knob);
        mAnchorDelete = CameraApp.getApp().getResources().getDrawable(R.drawable.aviary_delete_knob);
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(CameraApp.getApp().dp2px(1));
