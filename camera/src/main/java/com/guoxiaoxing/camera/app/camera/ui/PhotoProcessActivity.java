package com.guoxiaoxing.camera.app.camera.ui;
...
import com.guoxiaoxing.camera.app.camera.CameraBaseActivity;
import com.guoxiaoxing.camera.app.camera.CameraManager;
import com.guoxiaoxing.camera.app.camera.EffectService;
import com.guoxiaoxing.camera.app.camera.adapter.FilterAdapter;
import com.guoxiaoxing.camera.app.camera.adapter.StickerToolAdapter;
import com.guoxiaoxing.camera.app.camera.effect.FilterEffect;
import com.guoxiaoxing.camera.app.camera.util.EffectUtil;
import com.guoxiaoxing.camera.app.camera.util.GPUImageFilterTools;
import com.guoxiaoxing.camera.app.model.Addon;
import com.guoxiaoxing.camera.app.model.FeedItem;
import com.guoxiaoxing.camera.app.model.TagItem;
import com.guoxiaoxing.camera.app.ui.EditTextActivity;
...
import com.guoxiaoxing.camera.util.TimeUtils;
import com.guoxiaoxing.camera.widget.LabelSelector;
...
public class PhotoProcessActivity extends CameraBaseActivity {
    ...
    private void initView() {
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(CameraApp.getApp().getScreenWidth(),
                CameraApp.getApp().getScreenWidth());
        mImageView.setLayoutParams(params);
        overlay.setLayoutParams(params);
        drawArea.addView(overlay);
        //添加标签选择器
        RelativeLayout.LayoutParams rparams = new RelativeLayout.LayoutParams(CameraApp.getApp().getScreenWidth(), CameraApp.getApp().getScreenWidth());
